...
@section('content')
 ...
 <div class="block">
    <div class="block-header">
        <h3 class="block-title">هدف العميل<small></small></h3>
    </div>
        ...
        <table class="table table-bordered table-striped table-vcenter js-dataTable-buttons">
            ...
            <tbody>
                ...
                <td class="text-center font-size-sm">{{$loop->iteration}}</td>
                    ...
                    <a href="{{route('goals.show',$item->id)}}">{{$item->name_ar}}</a>
                    </td>
                    ...
                    <td class="text-center">
                        <div class="btn-group">
                            ...
                            <a href="javascript" class="btn btn-sm btn-primary delete-link"   data-route="{{route('goals.destroy',$item->id)}}" data-toggle="modal" data-target="#modal-block-normal" title="Edit">
