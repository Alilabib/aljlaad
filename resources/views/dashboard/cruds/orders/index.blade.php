                ...
                <td class="text-center font-size-sm">{{$loop->iteration}}</td>
                    ...
                    <td class="text-center">
                        <div class="btn-group">
                            ...
                            <a href="javascript" class="btn btn-sm btn-primary delete-link"   data-route="{{route('orders.destroy',$item->id)}}" data-toggle="modal" data-target="#modal-block-normal" title="Edit">
