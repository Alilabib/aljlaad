            ...
            <div class="row items-push">
                ...
                <div class="col-lg-8 col-xl-5">
                    ...
                    <div class="form-group">
                        ...
                        <textarea class="form-control" id="val-suggestions" name="desc_en" rows="5" placeholder="وصف  بالإنجليزية">@isset($data)
                            {{$data->desc_en}}
                                @endisset</textarea>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <input type="number" min="1" class="form-control" id="val-password" name="price" placeholder=" السعر" min="1" @isset($data)
                        value="{{$data->price}}"
                            @endisset>
                    </div>
                        ...
                        @isset($data)
                            <div class="col-md-4 animated fadeIn">
                                <div class="options-container fx-item-zoom-in">
                                    <img class="img-fluid options-item" src="{{asset('storage/uploads/products/'. $data->img)}}">
                                </div>
                            </div>
                        @endisset
