...
@section('content')
 ...
 <div class="block">
    <div class="block-header">
        <h3 class="block-title">  المنتجات <small></small></h3>
    </div>
        ...
        <table class="table table-bordered table-striped table-vcenter js-dataTable-buttons">
            ...
            <tbody>
                ...
                <td class="text-center font-size-sm">{{$loop->iteration}}</td>
                    ...
                    <td class="d-none d-sm-table-cell font-size-sm">
                        <img src="{{asset('storage/uploads/products/'. $item->img)}}" style="width:60px;height:60px">
                    </td>
                    <td>
                    ...
                    <td class="text-center">
                        <div class="btn-group">
                            ...
                            <a href="javascript" class="btn btn-sm btn-primary delete-link"   data-route="{{route('products.destroy',$item->id)}}" data-toggle="modal" data-target="#modal-block-normal" title="Edit">
