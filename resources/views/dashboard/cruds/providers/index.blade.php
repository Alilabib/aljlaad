...
@section('content')
 ...
 <div class="block">
    <div class="block-header">
        <h3 class="block-title">مندوبين التوصيل<small></small></h3>
    </div>
                ...
                <td class="text-center font-size-sm">{{$loop->iteration}}</td>
                    ...
                    <td class="text-center">
                        <div class="btn-group">
                            ...
                            <a href="{{route('providers.edit',$item->id)}}" class="btn btn-sm btn-primary" data-toggle="tooltip" title="Edit">
                                <i class="fa fa-fw fa-pencil-alt"></i>
                            </a>
                            <a href="javascript" class="btn btn-sm btn-primary delete-link"   data-route="{{route('providers.destroy',$item->id)}}" data-toggle="modal" data-target="#modal-block-normal" title="Edit">
